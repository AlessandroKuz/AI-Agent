...
def call_function(function_call_part: types.FunctionCall, verbose: bool = False) -> None:
    """
    Executes the provided function call.
    :param function_call_part: The function call to execute.
